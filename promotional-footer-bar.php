			...
			'offers' => array(
				...
				'templates' => array(
					array(
						...
						'title'          => __( 'BLACK FRIDAY SALE: Get 30% OFF All WordPress Themes & Plugins — Use Code: BLCK30 at Checkout!', 'promotional-footer-bar' ),
						'mobile_title'   => __( 'BLACK FRIDAY: 30% OFF — Code: BLCK30', 'promotional-footer-bar' ),
						'cta_text'       => __( 'Shop Now', 'promotional-footer-bar' ),
						'cta_url'        => 'https://wbcomdesigns.com/downloads/',
						'secondary_text' => __( 'Copy Code: BLCK30', 'promotional-footer-bar' ),
						'secondary_url'  => '#',
						'bg_color'       => '#000000',
						'text_color'     => '#ffffff',
						'cta_bg_color'   => '#dc2626',
					...
					array(
						'name'           => __( 'Cyber Monday Deal', 'promotional-footer-bar' ),
						'title'          => __( 'CYBER MONDAY: 30% OFF BuddyPress & WooCommerce Plugins — Use Code: BLCK30 Before It Expires!', 'promotional-footer-bar' ),
						'mobile_title'   => __( 'CYBER MONDAY: 30% OFF — BLCK30', 'promotional-footer-bar' ),
						'cta_text'       => __( 'Shop Now', 'promotional-footer-bar' ),
						'cta_url'        => 'https://wbcomdesigns.com/downloads/',
						'secondary_text' => __( 'Copy Code: BLCK30', 'promotional-footer-bar' ),
						'secondary_url'  => '#',
					...
					array(
						...
						'title'          => __( 'FLASH SALE: 30% OFF All Products — Ends in 24 Hours! Use Code: BLCK30 Now', 'promotional-footer-bar' ),
						'mobile_title'   => __( '30% OFF — 24 Hours Only! BLCK30', 'promotional-footer-bar' ),
